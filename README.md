...
### ALGOgent Runtime
Lightweight runtime intelligence SDK for Python automation scripts and AI pipelines.
Synchronous, plug-and-play, zero configuration.
...
### Adaptive Runtime
Runtime intelligence layer for long-running stateful systems and production services.
Five async engines that analyze context, score confidence, make decisions, persist state, and recover from crashes.
